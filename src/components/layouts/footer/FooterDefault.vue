<script setup>
import logoDark from "@/assets/img/icons/logo/medical-check.png";
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 mb-4 ms-auto">
          <div >
            <a :href="brand.route" class="d-flex justify-content-start align-items-center">
              <img :src="brand.logo" class="mb-3 footer-logo w-15 h-15" alt="main_logo" />
              <h6 class="font-weight-bolder">S7I7A.ma</h6>
            </a>
          </div>
          <div>

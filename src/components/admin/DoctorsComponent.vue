          ...
          <div class="card ">
            <div class="card-header pb-0 p-3 mb-3">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <router-link class="btn btn-primary" :to="{path:'/admin/doctors/create'}">Add a Doctor</router-link>
              </div>
            </div>
            <AllDoctorsComponent/>
          </div>
    ...
    data(){
        return{
            navigationLinks: [
                ...
                { url: "/admin/doctors", text: "Doctors", iconClass: "bx bx-plus-medical calendar-grid-58 text-warning text-sm opacity-10" ,active:"nav-link active"},

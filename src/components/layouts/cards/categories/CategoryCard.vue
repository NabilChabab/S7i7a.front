...
<template>
  <div class="container mt-sm-5" data-aos="fade-up"
    ...
    <div
      ...
      :style="{
        backgroundImage:
          'url(https://img.freepik.com/free-photo/young-handsome-physician-medical-robe-with-stethoscope_1303-17818.jpg?w=1380&t=st=1710777903~exp=1710778503~hmac=d34ed3db36afd3ebfcc0b705e54e0697b13d549cb0c7a12991b98b517f2b7abe)'
      }"
      loading="lazy"
    >

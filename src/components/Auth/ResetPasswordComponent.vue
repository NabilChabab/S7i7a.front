...
<main class="main-content  mt-0">
  <section class="min-vh-100 mb-8">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg bg-gradient-primary">
      ...
      <div class="row mt-lg-n11 mt-md-n11 mt-n10">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="row px-xl-5 px-sm-4 px-3">
              <div class="col-3 ms-auto px-1">
                <a class="btn btn-outline-light w-100" href="javascript:;">
                  <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink32">
            ...
            <div class="card-body">
              <form role="form text-left" @submit.prevent="resetPassword" class="container">
                <div class="mb-3" :class="{error : errors.email}">
                  <input type="hidden" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon" v-model="email" id="email">
                  <span v-if="errors.email" class="text-danger">{{errors.email}}</span>
                </div>
                <div class="mb-3" :class="{error : errors.password}">
                  <input type="password" class="form-control" placeholder="New Password" aria-label="Password" aria-describedby="password-addon" id="password" v-model="password">
                  <span v-if="errors.password" class="text-danger">{{errors.password}}</span>
                </div>
                <div class="mb-3" :class="{ error: errors.confirmPassword }">
                  <input type="password" class="form-control" placeholder="Confirm Password" aria-label="Password" aria-describedby="password-addon" id="confirmPassword" v-model="confirmPassword">
                ...
                <p class="text-sm mt-3 mb-0 text-center">Already have an account? <router-link class="text-dark font-weight-bolder" :to="{path:'login'}">Sign in</router-link></p>
              </form>
            </div>
          </div>
        </div>
